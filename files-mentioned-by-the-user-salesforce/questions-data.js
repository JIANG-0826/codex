window.ADM201_QUESTION_BANK = {
  ...
  "categories": [
    ...
    {
      "title": "Sales and Marketing Applications",
      "weight": 10,
      "count": 14
    },
    {
      "title": "Service and Support Applications",
      "weight": 10,
      "count": 12
    },
    {
  ...
  "questions": [
    {
      ...
      "sourceCategory": "Service and Support Applications",
      "weight": 10,
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "D",
          "text": "Automation event triggered flow"
        }
      ],
      "answer": [
        "A"
    ...
    },
    {
      ...
      "sourceCategory": "Object Manager and Lightning App Builder",
      "weight": 15,
    ...
    },
    {
      ...
      "sourceCategory": "Configuration and Setup",
      "weight": 15,
    ...
    },
    {
      ...
      "sourceCategory": "Data and Analytics Management",
      "weight": 17,
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Submit for Approval button"
        },
        {
          "label": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Activate Email-to-Case for the agent."
        },
        {
          "label": "B",
          "text": "Configure a new Service Console layout."
        },
        {
          "label": "C",
          "text": "Verify Data Cloud is implemented."
        },
        {
          "label": "D",
          "text": "Create new user profiles for the agent."
        }
      ],
      "answer": [
        "C"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Escalation Rules with Business Hours"
        },
        {
          "label": "B",
          "text": "Record-Triggered Flows with Business Hours"
        },
        {
          "label": "C",
          "text": "Case Assignment Rules with Business Hours"
        },
        {
          "label": "D",
          "text": "Milestones with Business Hours"
        }
      ],
      "answer": [
        "D"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Edit the Type field and change the name."
        },
        {
          "label": "B",
          "text": "Use Rename Tabs and Labels."
        },
        {
          "label": "C",
        ...
        {
          "label": "D",
          "text": "Create a global picklist value set."
        }
      ],
      "answer": [
        "B"
    ...
    },
    {
      ...
      "explanation": "Flow Builderis the recommended tool for automating updates to multiple related records based on a change to a single record. A \"Record-Triggered Flow\" can be configured to execute whenever an Opportunity is updated to \"Closed Won\". The flow can then find all other Opportunities related to the same Account where the \"IsClosed\" field is false, and use anUpdate Recordselement to set their stage to \"Closed Lost\". Outbound Messages (Option B) are used for notifying external systems, not for internal data updates31. Flow Orchestration (Option C) is designed for multi-user, complex business processes and would be overly complicated for this simple record update32. Quick Actions (Option D) require a user to click a button, which does not meet the requirement for automatic rendering upon the stage change33."
    },
    {
      "id": 89,
      "uid": "q017",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "C",
          "text": "Use the native debug feature in Flow Builder."
        },
        {
          "label": "D",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "B",
          "text": "Macros with Quick Actions"
        },
        {
          "label": "C",
          "text": "Quick Text with Email Templates"
        },
        {
          "label": "D",
          "text": "Autolaunched Flows with Email Alerts"
        }
      ],
      "answer": [
        "B"
    ...
    },
    {
      ...
      "sourceCategory": "Sales and Marketing Applications",
      "weight": 10,
      ...
      "explanation": "The Kanban view provides a visual representation of a set of records, such as an opportunity pipeline, organized by a specific field like \"Stage\". It allows sales teams to see all their deals as cards in columns. The primary benefit of Kanban is its \"drag-and-drop\" functionality, which lets users move a card from one column to another to automatically update the stage, effectively \"moving opportunities forward\" with minimal effort. While reports (Option A) and dashboards (Option B) provide visual summaries, they do not allow for the interactive, one-click record updates that the Kanban view offers11. Standard list views (Option D) show data in a grid format which is less visual for tracking pipeline progress compared to the column-based Kanban layout."
    },
    {
      "id": 109,
      "uid": "q022",
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Add Specific Entry Criteria."
        },
        {
          "label": "B",
          "text": "Use Dynamic Forms to display a button."
        },
        {
          "label": "C",
          "text": "C. Create a screen flow."
        },
        {
          "label": "D",
          "text": "Add a validation rule to the opportunity."
        }
      ],
      "answer": [
        "A"
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "D",
          "text": "Prompt Builder runs a simulated call to the large language model to save on costs, so the prompt is never sent to the actual model."
        }
      ],
      "answer": [
        "B"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Process Definition Detail"
        },
        {
          "label": "B",
          "text": "Approval Steps"
    ...
    },
    {
      ...
      "sourceCategory": "Agentforce AI",
      "weight": 8,
      "question": "Cloud Kicks wants Agentforce to adapt its behavior based on real-time customer input. Which feature directly enables this capability?1",
      "options": [
        {
          "label": "A",
          "text": "Data Cloud"
    ...
    },
    {
      ...
      "explanation": "The most efficient and standard way to automate case creation from inbound emails is by using Email-to- Case. When setting up Email-to-Case, the Platform Administrator configures \"Routing Addresses\". For each routing address (e.g., support@company.com or billing@company.com), the administrator can specify a default owner or queue for the cases created via that specific address. This ensures that when a customer sends an email to the \"Support\" address, it is automatically routed to the Support Queue, and an email to the \"Billing\" address is routed to the Billing Queue. This configuration is handled directly within the Email-to- Case setup pages and does not require additional escalation rules (Option A) or complex custom flows (Option C) for the initial assignment. While a custom email service (Option B) is possible, it is a developer- centric approach that is generally unnecessary given the robust native capabilities of the standard Email-to- Case feature. This setup streamlines the intake process and ensures that customer issues are immediately visible to the correct service team34."
    },
    {
      "id": 108,
      "uid": "q033",
      ...
      "options": [
        {
          "label": "A",
          "text": "Generating cold calls"
        },
        {
          "label": "B",
          "text": "Automating all marketing content"
        },
        {
          "label": "C",
          "text": "Providing basic web bot chats"
        },
        {
          "label": "D",
          "text": "Automating Lead Qualification"
        }
      ],
      "answer": [
        "D"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Guidance for Success"
        },
        {
          "label": "B",
          "text": "Big Deal Alerts"
        },
        {
          "label": "C",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "C",
          "text": "The user’s profile"
        },
        {
          "label": "D",
          "text": "Custom permission sets"
        }
      ],
      "answer": [
        "C"
    ...
    },
    {
      ...
      "sourceCategory": "Productivity and Collaboration",
      "weight": 10,
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "C",
          "text": "Lightning Page Visibility Rule"
        },
        {
          "label": "D",
          "text": "Lightning App Builder Analytics"
        }
      ],
      "answer": [
        "D"
    ...
    },
    {
      ...
      "sourceCategory": "Configuration and Setup",
      "weight": 15,
      "question": "Cloud Kicks has the organization wide defaults for Opportunity set to Private. Which two features should a Platform Administrator use to open up access to opportunity records for sales users working on collaborative deals?63",
      "options": [
        {
          "label": "A",
          "text": "Sharing rules"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Similar Opportunities"
        },
        {
          "label": "B",
          "text": "Opportunity Update Reminders"
        },
        {
          "label": "C",
          "text": "Big Deal Alerts"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Use a Text Widget."
        },
        {
          "label": "B",
          "text": "Assign a new Task to each rep."
        },
        {
          "label": "C",
          "text": "Use the Highlights Panel."
        },
        {
          "label": "D",
          "text": "Send out a mass email."
        }
      ],
      "answer": [
        "A"
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "C",
          "text": "C. Delegated administrators cannot modify permission sets."
        },
        {
          "label": "D",
    ...
    },
    {
      ...
      "sourceCategory": "Object Manager and Lightning App Builder",
      "weight": 15,
      "question": "A Platform Administrator has been asked to change the data type of an auto number to a text field. What should the administrator be aware of before changing the field?99",
      "options": [
        {
          "label": "A",
        ...
        {
          "label": "B",
          "text": "Changing Auto Number field to Text is prevented."
        },
        {
          "label": "C",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "B",
          "text": "B. \"This action updates the customer's shipping address. It is to be used when a user wants to change their address. Only use this when a customer does not have an active order in the system.\""
        },
        {
          "label": "C",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "B",
          "text": "Create a Dynamic Dashboard."
        },
        {
          "label": "C",
          "text": "Set View Dashboard As to Me."
        },
        {
          "label": "D",
          "text": "Set View Dashboard As to Another person."
        }
      ],
      "answer": [
        "B"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Create a custom report type with relevant fields."
        },
        {
          "label": "B",
          "text": "Create a custom field on the Campaign object for the type of initiative."
        },
        {
          "label": "C",
          "text": "Create record types and page layouts for each type of campaign."
        },
        {
          "label": "D",
          "text": "Use campaign hierarchies to organize campaign types."
        }
      ],
      "answer": [
        "C"
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "C",
          "text": "C. Configure Opportunity Path."
        },
        {
          "label": "D",
    ...
    },
    {
      ...
      "sourceCategory": "Automation",
      "weight": 15,
      "question": "Which Salesforce feature allows a Platform Administrator to automate3the routing of records to specific users for review and decision-making based on predefined criteria?",
      "options": [
        {
          "label": "A",
    ...
    },
    {
      ...
      "sourceCategory": "Agentforce AI",
      "weight": 8,
      "question": "A Platform Administrator is adding a new topic to an agent. What is best practice for topic instructions?70",
      "options": [
        {
          "label": "A",
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Hide Report Types"
        },
        {
          "label": "B",
          "text": "Report Folder Sharing"
        },
        {
          "label": "C",
          "text": "Standard Report Types"
        },
        {
          "label": "D",
          "text": "Joined Report"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Download the solution from AppExchange."
        },
        {
          "label": "B",
          "text": "Install a package from the Partner Portal."
        },
        {
          "label": "C",
          "text": "Create a managed package in AppExchange."
        },
        {
          "label": "D",
          "text": "Configure the package from Salesforce Setup."
        }
      ],
      "answer": [
        "A"
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "B",
          "text": "Add Lightning component to a layout."
        },
        {
          "label": "C",
    ...
    },
    {
      ...
      "sourceCategory": "Automation",
      "weight": 15,
      "question": "Which action should a Platform Administrator configure to reverse a submitted approval request and unlock the associated record when setting up an approval process?99",
      "options": [
        {
          "label": "A",
          "text": "Final Rejection Actions"
        },
        {
          "label": "B",
          "text": "Recall Actions"
    ...
    },
    {
      ...
      "sourceCategory": "Data and Analytics Management",
      "weight": 17,
      "question": "A group of sales reps can view each other’s orders on a report; however, they would like a report to view just their own orders. What should a Platform Administrator do to set up a report for the sales reps?31",
      "options": [
        {
          "label": "A",
          "text": "Set the Opportunity Filter for Primary as True."
        },
        {
          "label": "B",
          "text": "Filter by Opportunity Owner equals $USER."
        },
        {
          "label": "C",
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Process Automation Settings"
        },
        {
          "label": "B",
          "text": "Debug Logs"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "A. Configure opportunity team members to track internal and external stakeholders."
        },
        {
          "label": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "C",
          "text": "Edit the role to enable Sales access."
        },
        {
          "label": "D",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "C",
          "text": "The Dashboard folder is set to Private."
        },
        {
          "label": "D",
    ...
    },
    {
      ...
      "sourceCategory": "Agentforce AI",
      "weight": 8,
      "question": "When Agentforce performs its grounding check, it examines source information, the topic instructions, and scope. Which additional information does the agent look for during its grounding check?39",
      "options": [
        {
          "label": "A",
          "text": "Incompatible data types"
        },
        {
          "label": "B",
          "text": "Prompt injection risks"
        },
        {
          "label": "C",
        ...
        {
          "label": "D",
          "text": "The web for information verification"
        }
      ],
      "answer": [
        "B"
      ],
      "explanation": "Groundingis the process by which an AI agent retrieves and uses specific, trusted data to ensure its responses are accurate and relevant41. During this process, Salesforce's Einstein Trust Layerperforms several critical checks, including identifyingPrompt Injection risks424242. Prompt injection refers to attempts by a user to \"trick\" the AI into ignoring its instructions or revealing sensitive data by entering malicious commands into the chat interface43. By checking for these risks during the grounding phase, the agent can ensure that the instructions it uses to generate a response remain secure and aligned with company policies44. While the agent respects field security, \"Encrypted fields\" (Option C) are handled at the data access layer rather than as part of the linguistic grounding check45. Standard Agentforce agents do not browse the open web for verification (Option D) as they are intended to remain grounded strictly in the company's verified internal data46."
    },
    {
      "id": 12,
      "uid": "q097",
    ...
    },
    {
      ...
      "sourceCategory": "Service and Support Applications",
      "weight": 10,
      "question": "Cloud Kicks needs to change the owner of a case when it has been open for more than 7 days. What should a Platform Administrator use to complete this requirement?47",
      "options": [
        {
          "label": "A",
          "text": "Escalation Rules"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Reassign the user's license during leave."
        },
        {
          "label": "B",
          "text": "Change the Login Hours for the profile."
        },
        {
          "label": "C",
          "text": "Freeze the user's account."
        },
        {
          "label": "D",
          "text": "Restrict Login IP Addresses for the profile."
        }
      ],
      "answer": [
        "C"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Single-step predefined processes"
        },
        {
          "label": "B",
          "text": "Static document generation"
        },
        {
          "label": "C",
        ...
        {
          "label": "D",
          "text": "Tasks without decision-making"
        }
      ],
      "answer": [
        "C"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Set sharing model as Public Read/Write for the respective object(s)."
        },
        {
          "label": "B",
          "text": "Set sharing model as Private for the respective object(s)."
        },
        {
          "label": "C",
          "text": "Create multiple reports, each filtered to show records owned by each user."
        },
        {
          "label": "D",
          "text": "Use Apex sharing to hide records."
        }
      ],
      "answer": [
        "B"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Provides the best answer possible with caveats"
        },
        {
          "label": "B",
          "text": "Gives an error message"
        },
        {
          "label": "C",
          "text": "Routes to a live agent"
        },
        {
          "label": "D",
          "text": "D. Asks for additional information"
        }
      ],
      "answer": [
        "D"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "The user is the running user of a dashboard."
        },
        {
          "label": "B",
        ...
        {
          "label": "C",
          "text": "The user is part of an Opportunity team."
        },
        {
          "label": "D",
          "text": "The user is part of an Account team."
        }
      ],
      "answer": [
        "A"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Create a flow to update the field."
        },
        {
          "label": "B",
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "B",
          "text": "Chatter Private Group"
        },
        {
          "label": "C",
          "text": "Chatter Public Group"
        },
        {
          "label": "D",
          "text": "Private Chatter Channel"
        }
      ],
      "answer": [
        "A"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "AND(LeadSource = 'Other', Source__c = '')"
        },
        {
          "label": "B",
          "text": "AND(NOT(LeadSource = 'Other'), NOT(Source__c = ''))"
        },
        {
          "label": "C",
          "text": "AND(ISPICKVAL(LeadSource,'Other'), ISBLANK(Source__c))"
        },
        {
          "label": "D",
          "text": "AND(NOT(ISPICKVAL(LeadSource,'Other'))), NOT(ISBLANK(Source__c))"
        }
      ],
      "answer": [
        "C"
    ...
    },
    {
      ...
      "options": [
        ...
        {
          "label": "B",
          "text": "Use specific technical terms and abbreviations to ensure the AI understands the specialised domain."
        },
        {
          "label": "C",
          "text": "Focus on providing high-level, theoretical concepts so the AI has the flexibility to respond creatively."
        },
        {
          "label": "D",
          "text": "Use natural, easy-to understand language and clear, concise instructions to guide the AI’s behavior."
        }
      ],
      "answer": [
        "D"
    ...
    },
    {
      ...
      "explanation": "Account Teamsare designed specifically for \"collaborative selling,\" allowing multiple users to work together on a single Account. By using Account Teams, an administrator can define specific roles (e.g., Sales Engineer, Support Rep) and grant them varying levels of access (Read/Write or Read Only) to the Account and its related Opportunities and Case. To meet the manager's requirement of \"streamlining\" and \"automatically adding\" members, the administrator should encourage users to set upDefault Account Teams. Once a user defines their default team in their personal settings, they can click a single button to add that entire team to any Account they own. Sharing Rules (Option B) are typically too broad for this requirement because they apply to all records meeting a criteria, rather than specific collaborative groups61. The Role Hierarchy (Option C) provides vertical access but doesn't easily handle the horizontal, project-based access required for support reps and engineers working on specific accounts62. Permission Sets (Option D) grant functional permissions (what a user can do) but do not grant access to specific data records in a collaborative way63."
    },
    {
      "id": 58,
      "uid": "q131",
    ...
    },
    {
      ...
      "sourceCategory": "Service and Support Applications",
      "weight": 10,
      "question": "Cloud Kicks wants to make sure clients are getting the attention they need and cases are not sitting longer than the Service Level Agreement (SLA) it has with its clients. Which standard feature helps route cases to a Tier 2 team if they have not been addressed in a specific amount of time?11",
      "options": [
        {
          "label": "A",
          "text": "Milestone and Entitlements"
        },
        {
          "label": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "A flow to assign Entitlements"
        },
        {
          "label": "B",
          "text": "Routing Configuration for each client"
        },
        {
          "label": "C",
          "text": "Email to Case for each service level"
        },
        {
          "label": "D",
          "text": "Case Assignment Rules for each client"
        }
      ],
      "answer": [
        "A"
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "Remove View access to the shared folder."
        },
        {
          "label": "B",
    ...
    },
    {
      ...
      "options": [
        {
          "label": "A",
          "text": "A. Create a screen flow that runs anytime an opportunity is closed."
        },
        {
          "label": "B",
        ...
        {
          "label": "D",
          "text": "Create an approval process with specific steps."
        }
      ],
      "answer": [
        "D"
